...
if(!document.getElementById("nav-character-messages").innerText.includes("(0)")) {//          if the number of messages is not zero,
  ...
  var msg=document.getElementById("nav-character-messages").innerText.replace("Messages",""); //take the number of messages
